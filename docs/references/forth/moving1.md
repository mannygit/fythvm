...
Source URL: https://www.bradrodriguez.com/papers/moving1.htm
...
This article first appeared in [The Computer Journal](http://www.psyber.com/~tcj) #59 (January/February 1993).
...
Author's note for web publication: the files formerly available on the GEnie online service are now available from the Forth Interest Group FTP server, [ftp://ftp.forth.org/pub/Forth](ftp://ftp.forth.org/pub/Forth).

[Continue with Part 2](https://www.bradrodriguez.com/papers/moving2.htm) | [Back to publications page](index.html)
